    ...
    <div style={{ minHeight: "100vh", background: "#f9fafb" }}>
      ...
      >
        ...
        >
              ...
              >
                <div
                  style={{
                    ...
                    flexShrink: 0,
                    backgroundColor:
                      i < step ? "#dbeafe" : i === step ? "#2563eb" : "#f3f4f6",
                    color:
                      i < step ? "#2563eb" : i === step ? "white" : "#9ca3af",
                  }}
                >
          ...
          {/* Right: actions */}
          <div
            className="builder-header-right"
            style={{
              display: "flex",
              alignItems: "center",
              gap: "8px",
          ...
          >
            ...
            >
              {saving && step < 2 ? (
                ...
                <Save size={13} className="show-mobile" />
              )}
