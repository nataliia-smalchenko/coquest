...
export default function NewResourcePage() {
  ...
  const { folders, tags, fetchFolders, fetchTags, fetchResources, selectedFolderId, selectedTagIds: preselectedTagIds } =
    useResourceStore();

  const [title, setTitle] = useState("");
  const [folderId, setFolderId] = useState<string>(selectedFolderId ?? "");
  const [selectedTagIds, setSelectedTagIds] = useState<string[]>(preselectedTagIds);
