  ...
  const handleCreate = async () => {
    ...
    try {
      const session = await createSession({
        quest_id: questId,
        scheduled_at: useScheduled && scheduledAt ? new Date(scheduledAt).toISOString() : undefined,
        ends_at: useEndsAt && endsAt ? new Date(endsAt).toISOString() : undefined,
        max_participants: useMaxParticipants && maxParticipants ? Number(maxParticipants) : undefined,
      })
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="h-16 flex items-center gap-4 mx-auto w-full" style={{ maxWidth: "1280px", paddingLeft: "20px", paddingRight: "20px" }}>
          <button
      ...
      {/* Content */}
      <div className="max-w-lg mx-auto mb-10 space-y-4" style={{ marginTop: "40px", paddingLeft: "24px", paddingRight: "24px" }}>
